...
void showHelpMenu()
{
    cout << "usage of OpenGal: " << endl;
    cout << '\t' << "OpenGal [OpenGal code] [name of output jedec] [gal type]" << endl;
    cout << '\t' << "OpenGal api [table data json] [name of output jedec] [gal type]" << endl;
    cout << '\t' << "OpenGal api [OpenGal code] [table data json] [gal type]" << endl;
    cout << '\t' << "OpenGal api [OpenGal code] [table data json]" << endl;
    cout << "Exampel:" << endl;
    cout << '\t' << "OpenGal code.txt out.jedec g22v10" << endl;
    cout << '\t' << "OpenGal api tableData.json out.jedec g22v10" << endl;
    cout << '\t' << "OpenGal api code.txt tableData.json g22v10" << endl;
    cout << '\t' << "OpenGal api code.txt tableData.json" << endl;
}
